                            ...
                            <form method="GET" action="{{ url()->current() }}"
                                ...
                                <select name="insurance_type"
                                    ...
                                    @foreach ($insuranceTypes as $type)
                                        <option value="{{ $type }}" {{ request('insurance_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                                ...
                                <tbody>
                                    @forelse ($histories as $index => $history)
                                        <tr>
                                            ...
                                            <td>{{ $history->premium_price ? number_format($history->premium_price) . ' PKR' : '-' }}</td>
                                            <td>{{ $history->sum_insured ? number_format($history->sum_insured) . ' PKR' : '-' }}</td>
                                            <td>{{ $history->payable_amount ? number_format($history->payable_amount) . ' PKR' : '-' }}</td>
                                            <td>{{ $history->benchmark ? $history->benchmark . '%' : '-' }}</td>
                                            <td>{{ $history->benchmark_price ? number_format($history->benchmark_price) . ' PKR' : '-' }}</td>
