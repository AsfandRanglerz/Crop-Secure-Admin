    ...
    <div class="modal fade" id="InsuranceTypesModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('insurance.sub.type.productionPrice.store') }}" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="EditInsuranceTypesModal-{{ $InsuranceSubType->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('insurance.sub.type.productionPrice.update', $InsuranceSubType->id) }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="historical_average_market_price" class="form-control" value="{{ old('historical_average_market_price', $InsuranceSubType->historical_average_market_price) }}">
                                            @error('historical_average_market_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="real_time_market_price" class="form-control" value="{{ old('real_time_market_price', $InsuranceSubType->real_time_market_price) }}">
                                            @error('real_time_market_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ensured_yield" class="form-control" value="{{ old('ensured_yield', $InsuranceSubType->ensured_yield) }}">
                                            @error('ensured_yield')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
